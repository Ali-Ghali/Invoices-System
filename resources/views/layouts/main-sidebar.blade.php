<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="mb-5 d-flex" style="padding-top:50px;"> <a href="{{ url('/' . $page='Home') }}"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="sign-favicon ht-40" alt="logo"></a><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Ghali<span>So</span>ft</h1></div>
			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/ali.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('قائمة الفواتير')
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">قائمة الفواتير</a></li><!-- عند الضغط على قائمة الفواتير سيأخذنا الى صفحة الفواتير-->
							@endcan
				 ...
				 @can('التقارير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
						@can('الاقسام')
							<li><a class="slide-item" href="{{ url('/' . $page='sections') }}">الأقسام</a></li> <!-- عند الضغط على الأقسام سيأخذنا الى صفحة الأقسام-->
							@endcan
							@can('المنتجات')
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}">المنتجات</a></li> <!-- عند الضغط على المنتجات سيأخذنا الى صفحة المنتجات-->
							@endcan
						</ul>
					</li>
					@endcan
