...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">مرحبا بكم في برنامج ادارة الفواتير</h2>
						  <p class="mg-b-0">الاحصائيات</p>
						</div>
					</div>
						...
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white"> 	<!-- هنا رح يجبلي مجموع اجمالي الفواتير -->
											{{ number_format(\App\Models\invoices::sum('Total'), 2) }}
											</h4>
											<p><h4>عدد الفواتير</h4></p>
											<p class="mb-0 tx-12 text-white op-7"><h4>{{ \App\Models\invoices::count() }}</h4></p> 	<!-- هنا رح يجبلي عدد الفواتير -->
										</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p><h4>عدد الفواتير الغير مدفوعة</h4></p>
											<p class="mb-0 tx-12 text-white op-7"><h4>{{ \App\Models\invoices::where('Value_Status', 2)->count() }}<h4></p>
										</div>
										<span class="float-right my-auto mr-auto">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p><h4>عدد الفواتير  المدفوعة</h4></p>
											<p class="mb-0 tx-12 text-white op-7"><h4>{{ \App\Models\invoices::where('Value_Status', 1)->count() }}</h4></p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p><h4>عدد الفواتير  المدفوعة جزئيا</h4></p>
											<p class="mb-0 tx-12 text-white op-7"><h4>{{ \App\Models\invoices::where('Value_Status', 3)->count() }}</h4></p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
