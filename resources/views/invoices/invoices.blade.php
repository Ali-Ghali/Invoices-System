...
<!-- 
                <form action="{{ route('import_invoices') }}" method="POST" enctype="multipart/form-data">  
                {{ csrf_field() }}
                  <input type="file" name="file" class="dropify" accept=".xlsx, .pdf,.jpg, .png, image/jpeg, image/png"
                                data-height="70" />
                                <br>
                                <button class="btn btn-success">استيراد اكسل</button>
                                          ...
                                          @foreach ($invoices as $Invoices)
                                           <?php $i++; ?>
							                <tr>
												...
												<td>
												<a
                                                 href="{{ url('InvoicesDetails') }}/{{ $Invoices->id }}">{{ $Invoices->section->ection_name }}</a>
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ URL::route('Status_show', [$Invoices->id]) }}"><i
                                                                class=" text-success fas fa-money-bill"></i>&nbsp;&nbsp; حالةالدفع</a>
