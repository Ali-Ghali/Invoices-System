                            ...
                            <div class="panel panel-primary tabs-style-2">
                                ...
                                <div class="panel-body tabs-menu-body main-content-body-right border">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab4"><!-- التاب رقم 4 خاص بمعلومات الفاتورة -->
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{ $invoices->section->ection_name }}</td><!-- جلب اسم القسم من جدول الاقسام عن طريق العلاقة المعمولة في المودل وذلك باستدعاء اسم التابع سكشن -->
                                                        </tr>
...
<!-- هنا في حال كانت الحالة تساوي الواحد تكون الفاتورة مدفوعة ونعطيها لون معين ورقم 2 تكون غير مدفوعة ونعطيها لون اخر -->
                                        ...
                                        <div class="tab-pane" id="tab5"><!-- التاب رقم 5 خاص بحالات الدفع -->
                                            <div class="table-responsive mt-15">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($details as $x)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $x->product }}</td>
                                                                <td>{{ $invoices->section->ection_name }}</td>
                                                                @if ($x->Value_Status == 1)
                                                                    <td><span
    ...
    <div class="modal fade" id="delete_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('delete_file') }}" method="post"> <!-- سيذهب الى الويب ليعمل راوت باسم ديليت فايل ثم الى الكنترولر -->
